...
export default function Button({
  ...
  const baseStyles =
    'relative overflow-hidden flex items-center lg:items-start rounded-[5px] p-[15px] text-[0.8rem] tracking-[0.5%] leading-[150%] uppercase font-bold cursor-pointer before:content-[""] before:absolute before:left-0 before:top-0 before:h-full before:w-[50px] before:rounded-[50px] before:transition-all before:duration-300 hover:before:w-full before:z-0'
