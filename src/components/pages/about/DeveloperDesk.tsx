...
export default function DeveloperDesk() {
  return (
    <section className="flex flex-col justify-center items-center min-h-screen pb-save-top pb-safe-bottom px-10 bg-[var(--bg-secondary)]">
        <div className="container mx-auto grid place-items-center grid-cols-1 lg:grid-cols-2 grid-rows-1 lg:grid-rows-2 gap-[16px]">
            <p className="text-[1rem] lg:text-[1.5rem] text-[#000000] tracking-[0.5%] lg:tracking-[1%] leading-[150%] lg:leading-[180%] text-center lg:w-[450px] lg:h-[400px] order-2 lg:order-none max-w-prose">
            ...
            <Image src="/myphoto.png" width={500} height={500} alt="Rectangle shape" objectFit="contain" className="w-[200px] lg:w-auto h-[200px] lg:h-auto order-1 lg:order-none rounded-full lg:rounded-none shadow-xl" />
            <p className="text-[1rem] lg:text-[1.5rem] text-[#000000] tracking-[0.5%] lg:tracking-[1%] leading-[150%] lg:leading-[180%] text-center lg:w-[450px] lg:h-[400px] order-3 lg:order-none max-w-prose">
