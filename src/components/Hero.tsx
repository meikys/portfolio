...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="container flex flex-col lg:flex-row lg:flex-wrap justify-start items-center gap-[32px] pb-safe-bottom pb-safe-top lg:pb-0 min-h-screen">
  ...
  <Image
    ...
    className="absolute top-0 left-0"
  />
  <div className="relative w-[150px] h-[150px] lg:w-auto lg:h-auto mx-auto">
    <Image
      src="/caesar.png"
      alt="Hero Image"
      layout="responsive"
