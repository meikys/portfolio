...
export default function Hero() {
  return (
    <section
      className="flex justify-center items-center min-h-[100dvh] px-10 bg-[var(--bg-secondary)] pt-[var(--safe-top)] pb-[var(--safe-bottom)]"
      id="#hero"
    >
      ...
      <div className="container flex flex-col lg:flex-row lg:flex-wrap justify-center items-center gap-[32px] max-h-[100dvh]">
