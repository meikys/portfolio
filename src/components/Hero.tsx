...
export default function Hero() {
  return (
    <section
      className="flex justify-center items-start bg-[var(--bg-secondary)] px-10"
      id="hero"
    >
      ...
      <div className="container flex flex-col lg:flex-row lg:flex-wrap justify-center items-center gap-[32px] pb-safe-bottom pb-safe-top lg:pb-0 min-h-screen">
  ...
  <Image
    ...
    className="absolute top-0 left-0"
  />
  <div className="relative w-auto h-auto lg:w-[550px] lg:h-[550px] mx-auto">
    <Image
      src="/caesar.png"
      alt="Hero Image"
      layout="responsive"
