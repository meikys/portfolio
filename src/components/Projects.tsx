  ...
  return (
    ...
    >
      {projects.map(({ id, number, title, description, button, bgColor, imageSrc }) => (
        <div key={id} className="flex flex-col-reverse lg:flex-row lg:justify-between gap-[32px] w-full min-h-[50vh] lg:min-h-[25vh] py-[64px] lg:py-0 group hover:bg-[#FFFFFF] transition ease-in-out duration-500 cursor-pointer lg:border-b lg:border-[#474747]/20 last:border-b-0">
