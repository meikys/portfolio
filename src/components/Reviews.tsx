        ...
        <div className="w-full pt-[32px]">
          <div
            className="flex flex-col gap-[16px] 
                  lg:flex-row lg:gap-[16px] lg:overflow-x-auto lg:min-w-0"
          >
            {reviews.map(({ id, personalName, brandName, review }) => (
              <div
                key={id}
                className="max-w-[300px] flex-shrink-0 flex flex-col gap-[16px] pb-[16px] 
                   border-b last:border-b-0 lg:border-b-0 border-[#474747]/10"
              >
                <div className="flex items-center gap-[8px]">
                  <h4 className="text-[1.25rem] text-[#000000] tracking-[0.5px] leading-[160%] font-bold">
                    {personalName}
                  </h4>
                  <span className="font-normal">-</span>
                  <h5 className="text-[0.875rem] text-[#474747] tracking-[0.5px] leading-[160%]">
                    {brandName}
                  </h5>
                </div>
                <p>{review}</p>
